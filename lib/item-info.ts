...
> = {
  ...
  counter: {
    name: 'ランダムガード',
    description: '使用ターン中、ドクロを引くと自分とセーフの2択ルーレットを表示。自分が選ばれるとバーストし、セーフなら誰もバーストせずターン終了。ドクロガード・身代わりとの併用不可。不発弾では発動しません。',
    icon: 'dice',
  },
  reposition: {
    name: '再配置',
  ...
  blessing: {
    name: '天使の加護',
    description: '所持中にドクロを引くと自動で発動し、通常のバーストやランダムガードによるバーストを1回防ぎます。発動後に消費されます。出現率1%（100回に1回）。',
    icon: 'blessing',
  },
};
